<template>
  <div class=" px-[8rem] py-[2rem]">
      <div class="flex">
          ...
          <div class=" space-y-6">
              <div>
                  <h1 class="text-orange-600 uppercase font-bold text-lg">About Us</h1>
            <h1 class="text-3xl font-signika font-bold">We Are Providing The Best Online Courses</h1>
              </div>
