  ...
  <div class="py-[6rem] px-[12rem] ">
      ...
      <div class="mt-6">
          <div class="grid grid-cols-3 gap-2">
              <div v-for="popular in popularCourses" :key="popular.id" class="flex flex-col bg-white drop-shadow-md rounded-sm">
                  <div class="">
                  ...
                  <div class="px-[1.5rem] py-[.5rem] space-y-2">
                      ...
                      <del class="font-source text-gray-400 font-thin">${{popular.normalAmount}}</del>
                      <!-- 7737200018 -->
                  </div>
                  ...
                  <div class="flex" v-else>
                      <span v-for="(star, i) in popular.rating" :key="i" class="las text-sm la-star text-gray-200"></span>
                  </div>
                  <hr>
      ...
      <div class="flex justify-center items-center mt-6">
        <a href="#" class="text-center bg-orange-500 rounded-md text-white font-bold font-source px-4 py-1.5">View All Courses</a>
      </div>  
  </div>
</template>
