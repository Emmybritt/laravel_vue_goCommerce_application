  ...
  <div class="px-[12rem] ">
      <div class="">
          <div class="grid grid-cols-3 gap-2">
              <div v-for="(popular, ind) in popularCourses" :key="popular.id" :style="{animationDelay: `${ind * 0.3}s`}" class="opacity-0 animate-fade-in-down flex flex-col bg-white drop-shadow-md rounded-lg">
                  <div class="relative">
